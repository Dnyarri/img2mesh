...
resultfile.writelines(
    [
        ...
        'Author: Automatically generated by img2mesh Python program\n',
        '   https://github.com/Dnyarri/img2mesh\n',
        '   https://gitflic.ru/project/dnyarri/img2mesh\n',
...
resultfile.writelines(
    [
        ...
        '#version 3.7;\n\n',
        'global_settings{\n',
        '    max_trace_level 3   // Set low to speed up rendering. May need to be increased for metals\n',
        '    adc_bailout 0.01    // Set high to speed up rendering. May need to be decreased to 1/256\n',
