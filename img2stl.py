...
from list2mesh import list2stl
...
sortir = Tk()
sortir.title('Image to STL conversion')
...
result_file_name = filedialog.asksaveasfilename(
    ...
    filetypes=[
        ('Stereolithography STL file', '.stl'),
        ('All Files', '*.*'),
    ],
    defaultextension=('Stereolithography STL file', '.stl'),
)
