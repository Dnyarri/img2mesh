    ...
    for y in range(0, Y, 1):
        ...
        for x in range(0, X, 1):
            ...
            resultfile.writelines(
                [
                    '3DFACE\n8\nMESH\n',    # Opening triangle 2
                    f'10\n{(xRescale*(xWrite-0.5+xOffset)):e}\n20\n{(yRescale*(yWrite-0.5+yOffset)):e}\n30\n{(zOffset+zRescale*v1):e}\n',
                    f'11\n{(xRescale*(xWrite+xOffset)):e}\n21\n{(yRescale*(yWrite+yOffset)):e}\n31\n{(zOffset+zRescale*v9):e}\n',
                    f'12\n{(xRescale*(xWrite+0.5+xOffset)):e}\n22\n{(yRescale*(yWrite-0.5+yOffset)):e}\n32\n{(zOffset+zRescale*v3):e}\n',
                    '62\n0\n0\n',  # triangle 2
                    '3DFACE\n8\nMESH\n',    # Opening triangle 4
                    f'10\n{(xRescale*(xWrite+0.5+xOffset)):e}\n20\n{(yRescale*(yWrite-0.5+yOffset)):e}\n30\n{(zOffset+zRescale*v3):e}\n',
                    f'11\n{(xRescale*(xWrite+xOffset)):e}\n21\n{(yRescale*(yWrite+yOffset)):e}\n31\n{(zOffset+zRescale*v9):e}\n',
                    f'12\n{(xRescale*(xWrite+0.5+xOffset)):e}\n22\n{(yRescale*(yWrite+0.5+yOffset)):e}\n32\n{(zOffset+zRescale*v5):e}\n',
                    '62\n0\n0\n',  # triangle 4
                    '3DFACE\n8\nMESH\n',    # Opening triangle 6
                    f'10\n{(xRescale*(xWrite+0.5+xOffset)):e}\n20\n{(yRescale*(yWrite+0.5+yOffset)):e}\n30\n{(zOffset+zRescale*v5):e}\n',
                    f'11\n{(xRescale*(xWrite+xOffset)):e}\n21\n{(yRescale*(yWrite+yOffset)):e}\n31\n{(zOffset+zRescale*v9):e}\n',
                    f'12\n{(xRescale*(xWrite-0.5+xOffset)):e}\n22\n{(yRescale*(yWrite+0.5+yOffset)):e}\n32\n{(zOffset+zRescale*v7):e}\n',
                    f'62\n0\n0\n',  # triangle 6
                    f'10\n{(xRescale*(xWrite-0.5+xOffset)):e}\n20\n{(yRescale*(yWrite+0.5+yOffset)):e}\n30\n{(zOffset+zRescale*v7):e}\n',
                    f'11\n{(xRescale*(xWrite+xOffset)):e}\n21\n{(yRescale*(yWrite+yOffset)):e}\n31\n{(zOffset+zRescale*v9):e}\n',
                    f'12\n{(xRescale*(xWrite-0.5+xOffset)):e}\n22\n{(yRescale*(yWrite-0.5+yOffset)):e}\n32\n{(zOffset+zRescale*v1):e}\n',
