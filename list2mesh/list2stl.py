...
def list2stl(image3d, maxcolors, resultfilename):
    ...
    def _src_lum(x, y):
        ...
        min_block = 0.7  # Blocking glueing tops and bottoms to non-manifold structures
    ...
    def _normal(x1, y1, z1, x2, y2, z2, x3, y3, z3):
        """Normal calculation."""
        ...
        length = sqrt((nx * nx) + (ny * ny) + (nz * nz))  # Pythagoras, in a good sense of this word
    ...
    # ↓ Combining all lists to file, writing by chunks to improve buffering.
    chunk_size = 700
